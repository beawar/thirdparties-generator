...
### Notice
Due to a dependency which refers to a GitHub repo, npx is not working. Use npm exec instead,
so
```bash
npx thirdparties-generator [args]
```
becomes
```bash
npm exec thirdparties-generator -- [args]
```
